...
<body class="hold-transition login-page" style="background-image: url('assets/img/bg1.jpg'); background-size: cover;  ">
  <div id="app">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <center>
              <img src="<?php echo base_url();?>assets/img/logo.jpg" alt="logo" width="200"></center>
